...
const EditKelompokModal = ({ isOpen, onClose, activity }) => {
...
<label
                  className={`block text-xs pt-2 ${
                    formData.team === ""
                      ? "text-red-600"
                      : "text-gray-900"
                  }`}
                >
                  Pilih asal kecamatan
                </label>
                <input
                  id="team"
                  name="team"
...
<label
              ...
              <div>
                    ...
                    <label
                      className={`block text-xs ${
                        formData.date === "" ? "text-red-600" : "text-gray-900"
                      }`}
                    >
                      Pilih tanggal pembentukan
                    </label>
                    <input
                      id="date"
                      name="date"
