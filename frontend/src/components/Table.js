      ...
      <div className="w-full p-2">
        {sortedData.length > 0 ? (
          sortedData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row, rowIndex) => (
            <div key={rowIndex} className="mb-4 border rounded-md p-4 bg-white">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-left">{truncateText(row.kelompok_desa, 60)}</h2>
                ...
                <div className="flex justify-center space-x-2">
                  ...
                  {profil.role === "Pegawai" ? (
                    ...
                    <div className="flex justify-center space-x-2">
                      ...
                      {row.status === "" || row.status === null ? <FontAwesomeIcon icon={faClock} className="text-gray-500" /> : null}
                    </div>
                  )}
                </div>
              </div>
              ...
              <div className="flex items-center text-sm text-gray-600 mt-2">
                ...
                <p className="text-left">{truncateText(row.jumlah_anggota_sekarang, 50)}</p>
              </div>
          ...
          <div className="flex flex-col items-center justify-center h-64 bg-white text-gray-600">
            <FontAwesomeIcon icon={faMagnifyingGlass} className="text-gray-500 mb-2" size="2x" />
            <p>Data Tidak Ditemukan, silahkan hapus beberapa filter atau ganti kata pencarian</p>
          </div>
        )}
